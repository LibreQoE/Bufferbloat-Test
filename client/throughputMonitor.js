...
class ThroughputMonitor {
    ...
    calculateDownloadThroughput(timeDelta) {
        ...
        const bytesReceivedDelta = bytesReceived - this.cumulativeBytesReceived;
    ...
    calculateUploadThroughput(timeDelta) {
        ...
        // Calculate delta from last measurement
        const bytesSentDelta = bytesSent - this.cumulativeBytesSent;
        ...
        // Log detailed throughput calculation
        console.log(`Upload throughput calculation: ${bytesSentDelta} bytes in ${timeDelta.toFixed(3)}s = ${throughput.toFixed(2)} Mbps (${streamCount} active streams)`);
